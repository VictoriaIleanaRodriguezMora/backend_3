...
`supertest` es quien ayuda a conectarse a la app, levantar la app y hacer las solicitudes a los endpoints

`modulo request` de supertst. pero se podría hacer tambien con fetch o axios
...
testing unitario:
test unitario 00:20:00 - 00:52:00
00:16:00

Testing DAO 01:00:00

Pendiente

- armar ejemplo de unitario
- armar ejemplo de dao (usar los metodos del dao y ver que se haya guardado ok) son las pruebas que se hacen manualmente en postman
- assert de node
